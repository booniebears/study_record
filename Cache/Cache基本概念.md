...
```
![Cache Structure.p![输入图片说明](Cache%20Structure.png)ng](Cache Structure.png)
...
```
![Cache直接映射.png](Cache直接映射.png)![输入图片说明](Cache%E7%9B%B4%E6%8E%A5%E6%98%A0%E5%B0%84.png)
...
```
![Cache Structure2.png](Cache Structure2.png)![输入图片说明](Cache%20Structure2.png)
